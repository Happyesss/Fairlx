...
export const SYSTEM_PROMPT_RULE_LINES = [
  ...
  "- When planning sprints from a spec, create sprints with startDate and endDate (ISO), put stories in those sprints, set storyPoints on every story/task, and set dueDate on every work item (ISO date). Estimate calendar days from story points (1 point ≈ 0.5 day) and the sprint length.",
