...
export const Sidebar = () => {
  ...
  if (isAccessLoading && hasOrg) {
    return (
      <aside className="h-full bg-background w-full overflow-hidden border-r border-border flex flex-col">
        <div className="flex items-center w-full h-[73px] px-6 border-b border-border flex-shrink-0">
          <Link href="/welcome">
  ...
  return (
    <aside id="sidebar" className="h-full  bg-sidebar w-full overflow-hidden border-r border-border flex flex-col">
      <div className="flex items-center w-full h-[73px] px-4 border-b border-border flex-shrink-0">
